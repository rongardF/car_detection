...
# local imports
from ...model.dto import PixelCoordinateDto
...
class PixelCoordinate(ResponseBase):
    ...
    @classmethod
    def from_dto(cls, dto: PixelCoordinateDto) -> 'PixelCoordinate':
        return PixelCoordinate(
            width=dto.width,
            height=dto.height,
        )
    ...
    @classmethod
    def to_dto(cls, model: 'PixelCoordinate') -> PixelCoordinateDto:
